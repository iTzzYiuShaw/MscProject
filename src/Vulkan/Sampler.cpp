...
Sampler::Sampler(const class Device& device, const RadianceSampler& config) :
	device_(device)
{
	VkSamplerCreateInfo samplerInfo = {};
	samplerInfo.sType = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO;
...
Sampler::Sampler(const class Device& device, const SphericalSampler& config) :
	device_(device)
{
	VkSamplerCreateInfo samplerInfo = {};
	samplerInfo.sType = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO;
...
Sampler::Sampler(const class Device& device, const SquaredSampler& config) :
	device_(device)
{
	VkSamplerCreateInfo samplerInfo = {};
	samplerInfo.sType = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO;
